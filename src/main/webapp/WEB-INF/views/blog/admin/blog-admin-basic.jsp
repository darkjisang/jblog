	...
	<div id="wrap">
		...
		<div id="content">
			...
			<div id="admin-content">
				<form action="${pageContext.request.contextPath}/${user.id}/admin/basicContent" method="post" enctype="multipart/form-data">
	 		      	<table id="admin-basic">
			      		...
			      		<tr>
			      			...
			      			<td><input id="textTitle" type="text" name="blogTitle" value="${myBlog.blogTitle}"></td>
			      		</tr>
			      		<tr>
			      			<td><label>로고이미지</label></td>
			      			<td class="text-left"><img src="${pageContext.request.contextPath }/upload/${myBlog.blogFile}"></td>
			      		</tr>      		
			      		<tr>
			      			<td>&nbsp;</td>
